INSERT
	...
	email,
	phone)
VALUES ('475ab972-6aa8-4964-9baa-1ea1b35b5b4e',
'Alfred Pennyworth',
'alfred.pennyworth@something.com',
'5551234') 
ON
CONFLICT(client_id) DO NOTHING;
...
INSERT
	...
	email,
	phone)
VALUES ('a1d317f1-45e3-4655-8cf8-3c61fe988bfe',
'Bruce Wayne',
'bruce.wayne@something.com',
'5555678') 
ON
CONFLICT(client_id) DO NOTHING;
...
INSERT
	...
	email,
	phone)
VALUES ('0d1549b4-7edc-45fa-a019-35bbb9e39de5',
'Clark Kent',
'clark.kent@something.com',
'5558765') 
ON
CONFLICT(client_id) DO NOTHING;
...
CONFLICT(apartment_id) DO NOTHING;
